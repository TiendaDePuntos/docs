...
<div className="tdp-landing">
  ...
  <section className="tdp-topics" id="primeros-pasos">
    <TopicCard
      ...
      <TopicCard
        eyebrow="PANTALLAS"
        title="Usá el panel con claridad"
        description="Conocé qué hace cada sección: clientes, puntos, catálogo, sorteos, encuestas, métricas y configuración."
        href="/pantallas-principales"
